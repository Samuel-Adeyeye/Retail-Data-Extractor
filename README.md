...
## 1. Project Overview
The **Retail Data Extractor** is a web application designed to automate the extraction of product information from retail leaflets. It leverages **Google's Gemini 1.5 Flash model** for multimodal analysis (Vision + Text) to identify products, prices, brands, and other metadata directly from images.
...
-   **Backend**: **Python (FastAPI)**.
    ...
    -   Interacts with **Google's Gemini 1.5 Flash model** using the `google-generativeai` Python SDK.
